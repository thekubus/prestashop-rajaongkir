...
class rajaongkir extends CarrierModule
{
	public  $id_carrier;

	private $_html = '';
	private $_postErrors = array();
	private $_moduleName = 'rajaongkir';
	...
	*/
	...
	{
		$this->name = 'rajaongkir_tk';
		$this->tab = 'shipping_logistics';
		$this->version = '0.0.1';
		$this->author = 'Benny Chandra';
		$this->limited_countries = array('id');

		parent::__construct ();

		$this->displayName = $this->l('Ongkos Kirim via rajaongkir.com');
		$this->description = $this->l('Estimasi biaya pengiriman berdasarkan situs rajaongkir.com');
	...
	public function install()
	{
		$carrierConfig = array(
			0 => array('name' => 'JNE',
				...
				'range_behavior' => 0,
				'delay' => array('en' => 'Shipping by JNE', 'id' => 'Pengiriman via JNE', Language::getIsoById(Configuration::get('PS_LANG_DEFAULT')) => 'Pengiriman via JNE'),
				'id_zone' => 1,
				'is_module' => true,
				'shipping_external' => true,
				'external_module_name' => 'rajaongkir',
				'need_range' => true
			),
			1 => array('name' => 'POS Indonesia',
				'id_tax_rules_group' => 0,
				'active' => true,
				'deleted' => 0,
				'shipping_handling' => false,
				'range_behavior' => 0,
				'delay' => array('en' => 'Shipping by POS Indonesia', 'id' => 'Pengiriman via POS Indonesia', Language::getIsoById(Configuration::get('PS_LANG_DEFAULT')) => 'Pengiriman via JNE'),
				'id_zone' => 1,
				'is_module' => true,
				'shipping_external' => true,
				'external_module_name' => 'rajaongkir',
